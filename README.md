[![Travis CI](https://img.shields.io/travis/inofix/ansible-acme-service-nginx.svg?style=flat)](http://travis-ci.org/inofix/ansible-acme-service-nginx)


Acme Cron Service - NGINX
=========================
...
------------
 ...
 # ansible-galaxy install inofix.acme-service-nginx
